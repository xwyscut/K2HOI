...
def get_args_parser():
    ...
    parser.add_argument('--image_verb_loss_type', type=str, default='focal', choices=('bce', 'focal', 'asl'),
                        help='Loss type for the image verb classification')
    parser.add_argument('--i_hidden_dim', default=512, type=int,
                        help="Size of the category query embeddings")
    parser.add_argument('--hoi_text', action='store_true',
                        help="Train for HOI if the flag is provided")
